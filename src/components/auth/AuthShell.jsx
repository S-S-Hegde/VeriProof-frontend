...
const AuthShell = ({ children, role = "student", mode = "login", step = 1 }) => {
  return (
    <div className="min-h-[90vh] w-full flex items-center justify-center p-2 sm:p-4 lg:p-6">
      <div className="w-full max-w-6xl rounded-3xl overflow-hidden border border-slate-300 dark:border-white/10 shadow-2xl bg-white dark:bg-[#070a14] grid grid-cols-1 lg:grid-cols-12 min-h-[680px] transition-colors duration-300">
        ...
        <div className="lg:col-span-7 flex flex-col items-center justify-center p-6 sm:p-10 lg:p-14 relative bg-slate-50/50 dark:bg-[#090d1b] overflow-y-auto transition-colors duration-300">
