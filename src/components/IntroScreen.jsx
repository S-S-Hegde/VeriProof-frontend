...
export default function IntroScreen({ onComplete }) {
  ...
  useEffect(() => {
    ...
    safeSetTimeout(() => setStage(1), 500);
    safeSetTimeout(() => setStage(2), 3000);
    safeSetTimeout(() => setStage(3), 3200);
    safeSetTimeout(() => setStage(4), 5500);
    safeSetTimeout(() => setStage(5), 5700);
    safeSetTimeout(() => setStage(6), 9500);
  ...
  useEffect(() => {
    ...
    setIsUnfolding(true);
    const t = setTimeout(() => {
      if (!hasCompleted.current && isMountedRef.current) {
        hasCompleted.current = true;
        onComplete?.();
      }
    }, 1500);
      ...
      <AnimatePresence mode="wait">
        {stage === 1 && (
          ...
          >
            ...
            >
              <LetterReveal
                text="IN A WORLD WHERE RESUMES LIE…"
                startDelay={0.1}
              />
            </p>
          </motion.div>
                ...
                {"VERIPROOF".split("").map((ch, i) => (
                  <motion.span
                    ...
                    style={{
                      ...
                      textShadow:
                        i % 2 !== 0 ? "0 0 40px rgba(37,99,235,0.6)" : "none",
                      fontStyle: "italic",
                      position: "relative",
                    }}
                  >
