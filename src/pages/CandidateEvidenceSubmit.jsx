...
const inputCls =
  "w-full bg-black/20 dark:bg-white/5 border border-[var(--color-border)] px-4 py-4 focus:border-[var(--color-accent)] focus:bg-transparent outline-none transition-all duration-300 text-sm font-mono tracking-wider placeholder:opacity-20 rounded-sm";
const labelCls =
  "text-[10px] uppercase tracking-[0.3em] font-bold opacity-40 flex items-center gap-2 mb-3";
...
const AddProject = () => {
  ...
  const addSnippet = () => {
    setSnippets([
      ...snippets,
      { title: "", code: "", language: "javascript", explanation: "" },
    ]);
  };
        ...
        <div className="mb-20">
          <div className="flex items-center justify-between mb-8">
            ...
            <div className="hidden md:flex flex-col items-end">
              <span className="text-4xl font-black italic opacity-10 tracking-tighter">
              ...
              <div className="flex gap-2 mt-4">
                {[1, 2, 3].map((step) => (
                  <div
                    key={step}
                    className={`h-1 w-12 transition-all duration-500 ${currentStep >= step ? "bg-[var(--color-accent)]" : "bg-[var(--color-border)]"}`}
                  />
                ))}
              </div>
            </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-10 relative z-10">
                      <div className="md:col-span-2">
                        ...
                        <input
                          ...
                          placeholder="E.G. REAL_TIME_CRYPTO_TRACKER"
                        />
                      </div>
                      ...
                      <div className="md:col-span-2">
                        ...
                        <input
                          ...
                          placeholder="REACT, NODEJS, REDIS..."
                        />
                      </div>
                  ...
                  <div className="bg-white/5 dark:bg-black/20 backdrop-blur-xl border border-[var(--color-border)] p-8 md:p-12 rounded-sm shadow-2xl">
                    ...
                    <div className="space-y-10">
                      {snippets.map((snippet, index) => (
                        <div
                          key={index}
                          className="p-8 bg-black/10 dark:bg-white/5 border border-[var(--color-border)] rounded-sm space-y-6 relative group transition-all hover:border-[var(--color-accent)]/30"
                        >
                          <button
                            type="button"
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                            <div>
                              ...
                              <input
                                ...
                                value={snippet.title}
                                onChange={(e) =>
                                  updateSnippet(index, "title", e.target.value)
                                }
                          ...
                          <div>
                            ...
                            <textarea
                              ...
                              value={snippet.code}
                              onChange={(e) =>
                                updateSnippet(index, "code", e.target.value)
                              }
                          ...
                          <div>
                            ...
                            <input
                              ...
                              placeholder="EXPLAIN_SIGNIFICANCE..."
                            />
                          </div>
                        </div>
                      ))}
                      {snippets.length === 0 && (
                        <div className="text-center py-20 border border-dashed border-[var(--color-border)] opacity-30">
                          <p className="text-sm font-mono uppercase tracking-[0.4em]">
                            Zero_Artifacts_Detected
                          </p>
                          <p className="text-[10px] mt-2 tracking-widest uppercase">
                            Highlighting code snippets increases verification
                            trust.
                          </p>
                        </div>
                      )}
              ...
              {currentStep === 3 && (
                ...
                >
                    ...
                    <div className="mb-12">
                      ...
                      <div className="flex items-center gap-6">
                        <input
                          ...
                          placeholder="E.G. 7.6 / 10"
                        />
                        <div className="flex items-start gap-3 opacity-40">
                          <AlertCircle className="w-4 h-4 mt-0.5 shrink-0" />
                          <p className="text-[10px] uppercase tracking-widest leading-relaxed">
                            System_Note: Skill evidence carries significantly
                            higher weight in recruiter analytics.
                          </p>
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="p-10 border border-dashed border-[var(--color-accent)]/30 bg-[var(--color-accent)]/5 rounded-sm flex items-start gap-6">
                    ...
                    <div>
                      <h4 className="text-sm font-black italic uppercase tracking-widest text-[var(--color-accent)] mb-2">
                        Ready_For_Manifestation
                      </h4>
                      <p className="text-xs font-medium opacity-50 leading-relaxed uppercase tracking-widest">
                        By submitting this evidence, you authorize the VeriProof
                        engine to cross-reference these artifacts with your
                        digital ledger.
                      </p>
                    </div>
                  </div>
              ...
              <div className="flex items-center gap-8">
                <div className="hidden sm:flex items-center gap-2">
                  {[1, 2, 3].map((step) => (
                    <div
                      key={step}
                      className={`w-2 h-2 rounded-full transition-all duration-500 ${currentStep === step ? "bg-[var(--color-accent)] scale-125" : "bg-[var(--color-border)]"}`}
                    />
                  ))}
                </div>
