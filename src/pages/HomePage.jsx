...
const FEATURES = [
  {
    icon: Fingerprint,
    title: "Forensic Identity",
    desc: "Commit patterns, code fingerprints, and cryptographic signatures ensure you are who you claim to be.",
    num: "01",
  },
  {
    icon: Layers,
    title: "Deep Stack Audit",
    desc: "Cross-referencing multiple repositories to build a unified talent profile that cannot be faked.",
    num: "02",
  },
  {
    icon: Scan,
    title: "Neural Plagiarism",
    desc: "Scanning billions of lines of open-source code to ensure 100% originality of evidence.",
    num: "03",
  },
  {
    icon: GitBranch,
    title: "Proof of Concept",
    desc: "Converting raw commits into meaningful professional signals that recruiters can actually trust.",
    num: "04",
  },
];
    ...
    <div ref={compRef} className="overflow-hidden -mt-24">
      ...
      >
        ...
        >
          ...
          <span className="text-[10px] font-mono uppercase tracking-[0.3em] text-[var(--color-muted)]">
            System_Online // Protocol_v5.0
          </span>
        </motion.div>
        ...
        <div className="text-center max-w-5xl relative z-10">
          <TextReveal>
            <h1
              className="font-black italic uppercase tracking-tighter leading-[0.85] mb-2"
              style={{ fontSize: "clamp(3.5rem, 11vw, 9rem)" }}
            >
              <span className="inline-block opacity-40">VERI</span>
        ...
        >
          Stop building resumes. Build a{" "}
          <strong className="font-bold text-[var(--color-text)]">
            legacy that can be proven.
          </strong>{" "}
          A forensic system designed to verify digital contributions with
          surgical precision.
        </motion.p>
        ...
        >
          {[...MARQUEE_ITEMS, ...MARQUEE_ITEMS, ...MARQUEE_ITEMS].map(
            (item, i) => (
              <span
                key={i}
                className="mx-6 text-xl md:text-3xl font-black italic uppercase tracking-tighter opacity-[0.06] hover:opacity-20 transition-opacity duration-500 shrink-0 cursor-default"
              >
                {item}
                <span className="text-[var(--color-accent)] mx-4 not-italic">
                  ·
                </span>
              </span>
            ),
          ...
          <div className="flex flex-col lg:flex-row lg:items-end justify-between mb-16 lg:mb-24 gap-8">
            ...
            <SectionReveal delay={0.2}>
              <p className="max-w-md text-sm text-[var(--color-muted)] leading-relaxed lg:text-right">
                Four interconnected verification protocols work in concert to
                construct an immutable proof layer around your professional
                identity.
              </p>
            </SectionReveal>
          </div>
            ...
            {FEATURES.map((f, i) => (
              ...
              >
                <div
                  ...
                  style={{
                    background:
                      "radial-gradient(400px circle at var(--vp-cursor-x, 50%) var(--vp-cursor-y, 50%), var(--color-accent-subtle), transparent 60%)",
                  }}
                />
                <span
                  className="absolute right-4 top-2 font-black italic opacity-[0.025] leading-none tracking-tighter pointer-events-none group-hover:opacity-[0.05] transition-opacity duration-700"
        ...
        <div className="max-w-[1400px] mx-auto grid grid-cols-1 lg:grid-cols-2">
          <div className="p-10 lg:p-16 xl:p-20 flex flex-col justify-center border-b lg:border-b-0 lg:border-r border-[var(--color-border)]">
            ...
            <TextReveal>
              <h2
                style={{ fontSize: "clamp(2.5rem, 5vw, 5rem)" }}
                className="font-black italic uppercase tracking-tighter leading-[0.85] mb-8"
              >
                Built for
                <br />
                Surgical
            ...
            <SectionReveal delay={0.3}>
              <p className="text-sm text-[var(--color-muted)] leading-relaxed max-w-md">
                Every number in your profile is cryptographically anchored to
                real commits, real code, real proof. No interpretation, no
                inflation — just verified signal.
              </p>
            </SectionReveal>
          </div>
          <motion.div className="grid grid-cols-2" style={{ y: statsY }}>
            {STATS.map((stat, i) => (
              <SectionReveal key={i} delay={i * 0.1}>
                <div
                  className={`p-8 lg:p-12 border-b border-r border-[var(--color-border)] group hover:bg-[var(--color-accent-subtle)] transition-colors duration-500 ${i === 1 || i === 3 ? "border-r-0" : ""} ${i >= 2 ? "border-b-0" : ""}`}
                >
          ...
          <div className="trust-heading">
            <TextReveal>
              <blockquote
                ...
                className="font-black italic uppercase tracking-tighter leading-[0.9] mb-10"
              >
                "The future of
                <br />
                hiring is not a<br />
